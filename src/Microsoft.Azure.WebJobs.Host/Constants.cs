...
namespace Microsoft.Azure.WebJobs.Host
{
    internal static class Constants
    {
        ...
        public const string UnableToResolveBindingParameterFormat = "Unable to resolve binding parameter '{0}'. Binding expressions must map to either a value provided by the trigger or a property of the value the trigger is bound to, or be a system binding expression(e.g.sys.randguid, sys.utcnow, etc.).";
    }
}
