...
namespace Microsoft.Azure.WebJobs.Host.Triggers
{
    internal class TriggeredFunctionInstanceFactory<TTriggerValue> : ITriggeredFunctionInstanceFactory<TTriggerValue>
    {
        ...
        public IFunctionInstance Create(FunctionInstanceFactoryContext<TTriggerValue> context)
        {
            ...
            return new FunctionInstance(Guid.NewGuid(), context.MessageId, context.ParentId, ExecutionReason.AutomaticTrigger, bindingSource, invoker, _descriptor);
        }
        ...
        public IFunctionInstance Create(FunctionInstanceFactoryContext context)
        {
            ...
            return new FunctionInstance(context.Id, context.MessageId, context.ParentId, context.ExecutionReason, bindingSource, invoker, _descriptor);
        }
