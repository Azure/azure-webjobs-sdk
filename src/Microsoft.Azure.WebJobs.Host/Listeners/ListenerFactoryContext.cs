...
namespace Microsoft.Azure.WebJobs.Host.Listeners
{
    ...
    public class ListenerFactoryContext
    {
        ...
        /// <param name="handler">The handler that should be called on listener exception</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> to use.</param>
        public ListenerFactoryContext(FunctionDescriptor descriptor, ITriggeredFunctionExecutor executor, IWebJobsExceptionHandler handler, CancellationToken cancellationToken)
        {
        ...
        /// <summary>
        /// Gets the web jobs exception handler
        /// </summary>
        public IWebJobsExceptionHandler ExceptionHandler { get; private set; }
