...
namespace Microsoft.Azure.WebJobs.Host.UnitTests
{
    internal static class FunctionIndexerFactory
    {
            ...
            IExtensionRegistry extensionRegistry = null, ILoggerFactory loggerFactory = null)
        {
            ...
            RetryStrategyProvider retryStrategyProvider = host.Services.GetService<RetryStrategyProvider>();
            ...
            return new FunctionIndexer(triggerBindingProvider, bindingProvider, activator, executor, singletonManager, loggerFactory, configuration, serviceScopeFactory, retryStrategyProvider);
        }
    }
}