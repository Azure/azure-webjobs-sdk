...
namespace Microsoft.Azure.WebJobs.Host.UnitTests
{
    internal static class FunctionIndexerFactory
    {
            ...
            IExtensionRegistry extensionRegistry = null, ILoggerFactory loggerFactory = null)
        {
            ...
            IRetryManagerProvider retryManagerProvider = host.Services.GetService<IRetryManagerProvider>();
            ...
            return new FunctionIndexer(triggerBindingProvider, bindingProvider, activator, executor, singletonManager, loggerFactory, configuration, retryManagerProvider);
        }
    }
}
