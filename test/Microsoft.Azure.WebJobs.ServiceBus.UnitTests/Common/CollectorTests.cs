...
namespace Microsoft.Azure.WebJobs.ServiceBus.UnitTests
{
    ...
    public class CollectorTests
    {
        ...
        public class Functions
        {
            ...
            public static void SendOneDirectNative([FakeQueue] out DirectFakeQueueData output)
            {
                output = new DirectFakeQueueData
                {
                     _test = "direct"
                };
            }
        ...
        public void Test()
        {
            ...
            var p9 = Invoke(host, client, "SendOneDirectNative");
