    ...
    public class BindToGenericItemTests
    {
            ...
            IAsyncConverter<TestStreamAttribute, Stream>
        {
            ...
            public void StreamRead(
                [TestStream(Path = "{k}", Access = FileAccess.Read)] Stream sr
                )
            {
            ...
            public void TextReaderRead(
                [TestStream(Path = "{k}", Access = FileAccess.Read)] TextReader tr
                )
            {
                _log = tr.ReadToEnd();
            }
            ...
            public void WriteStream(
                [TestStream(Path = "{k}", Access = FileAccess.Write)] Stream tw
                )
            {
