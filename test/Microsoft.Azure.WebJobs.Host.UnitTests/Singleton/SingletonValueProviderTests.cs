...
namespace Microsoft.Azure.WebJobs.Host.UnitTests.Singleton
{
    public class SingletonValueProviderTests
    {
        ...
        {
            Mock<SingletonManager> mockSingletonManager = new Mock<SingletonManager>(MockBehavior.Strict, null, new OptionsWrapper<SingletonOptions>(null), null, null, new FixedHostIdProvider(TestHostId), null);
